...
ALLOWED={"PACKAGE","CHANNEL","HAPI_BIN","NPM_BIN","BUN_BIN","HAPI_HOME","ROLE","UPDATE_MODE","SOURCE_REPO","PATCH_DIR","SCHEDULE_TZ","TARGET_HOUR","INTERVAL_DAYS","CATCH_UP_HOURS","UNKNOWN_RECENT_MINUTES","HEALTHCHECK_URL","VERIFY_COMMAND","QUIESCE_COMMAND","RESUME_COMMAND","USE_SUDO","KEEP_LOGS","KEEP_BACKUPS"}
